...
int ass10_main()
{
    ...
    const int thread_n = (int)thread::hardware_concurrency() - 1;
    ...
    *    Execution time (concurrently): 38122[ms]
    *   - Somehow this code doesn't run very well on Linux. I used exactly the same code with Windows and got better results.
    *   - See Visual Studio project in folder "Assignment10" for more information
    */
